...
class XrayClassification(data.Dataset):
    def __init__(self, root, set, transform=None, target_transform=None):
        self.root = root
        #self.root = '/Users/hgy/Desktop/hgy/HKUST/Class/Computer_Vision/Group_Project/CHR36/CHR' #root
        ...
        #file_csv = os.path.join(path_csv+'.csv')
