...
def main_ray():
    ...
    args.data='/Users/hgy/Desktop/hgy/HKUST/Class/Computer_Vision/Group_Project/CHR36/CHR'
    ...
    # define dataset
    train_dataset = XrayClassification(args.data, 'reduced_train')
    val_dataset = XrayClassification(args.data, 'reduced_test')
    num_classes = 5
